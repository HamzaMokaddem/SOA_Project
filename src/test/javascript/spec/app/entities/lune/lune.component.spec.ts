...
import { LuneComponent } from 'app/entities/lune/lune.component';
import { LuneService } from 'app/entities/lune/lune.service';
import { Lune } from 'app/shared/model/lune.model';

describe('Component Tests', () => {
  describe('Lune Management Component', () => {
    let comp: LuneComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LuneComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lunes && comp.lunes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
