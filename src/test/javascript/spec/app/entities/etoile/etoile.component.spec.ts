...
import { EtoileComponent } from 'app/entities/etoile/etoile.component';
import { EtoileService } from 'app/entities/etoile/etoile.service';
import { Etoile } from 'app/shared/model/etoile.model';

describe('Component Tests', () => {
  describe('Etoile Management Component', () => {
    let comp: EtoileComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtoileComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etoiles && comp.etoiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
